...
export default function DigitalMarketing() {
  return (
    <div className="pt-28 digital-marketing-page" style={{ backgroundColor: '#fef9f5' }}>
      <section className="w-full px-6">
        <div className="container mx-auto">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="dm-hero-heading text-4xl md:text-5xl font-bold font-(--font-orbitron)" style={{ background: 'var(--vawe-bg-gradient)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>
            Digital Marketing
          </motion.h1>
          <p className="dm-hero-copy mt-4 text-neutral-700 max-w-3xl">We build acquisition engines across SEO, social, paid media, email, and analytics — designed for measurable growth and a premium, modern brand experience.</p>
        </div>
      </section>
        ...
        <section key={s.title} className="py-4 md:py-8">
          <div className="w-full px-6">
            <div className="container mx-auto max-w-6xl">
              <div className={`relative grid md:grid-cols-2 gap-0 overflow-hidden rounded-2xl shadow-xl items-stretch ${s.reverse ? 'md:grid-flow-dense' : ''}`} style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fef9f5 100%)' }}>
                <div className={`relative p-6 md:p-8 flex flex-col justify-center ${s.reverse ? 'md:order-2' : ''} z-10`}>
                  ...
                  <h3 className="dm-section-title text-2xl md:text-3xl font-bold mb-3" style={{ color: headingColor }}>{s.title}</h3>
                  <p className="dm-section-copy text-base text-neutral-600 leading-relaxed mb-6">{s.copy}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {s.bullets.map((b, idx) => (
                      ...
                      >
                        ...
                        <div className="flex-1 p-2 dm-bullet-item rounded-lg transition-all duration-300 group-hover:shadow-md border" style={{ 
                          borderColor: `${s.color}30`,
                          background: `linear-gradient(135deg, ${s.color}05, transparent)` 
                        }}>
                          <span className="dm-bullet-text text-neutral-800 font-medium text-sm">{b}</span>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                ...
                <div className={`relative h-64 md:h-auto dm-image-container ${s.reverse ? 'md:order-1' : ''}`}>
                  ...
                  <div className="relative w-full h-full flex items-center justify-center p-6 md:p-8">
                    <div className="relative w-full h-full max-w-xl mx-auto group dm-image-wrapper">
                      ...
                      <div className="relative rounded-xl overflow-hidden shadow-lg border bg-white/50 backdrop-blur-sm" style={{ borderColor: `${s.color}40` }}>
                        <div className="relative w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-50 to-white p-6 dm-image-inner">
                          {s.headingImg ? (
                            <img 
                              src={s.headingImg} 
                              alt={s.title} 
                              className="w-full h-full object-cover max-h-64 rounded-lg dm-image" 
                              loading="lazy" 
                            ...
                            <img 
                              src={s.img} 
                              alt={s.title} 
                              className="w-full h-full object-contain max-h-64 dm-image" 
                              loading="lazy" 
                              referrerPolicy="no-referrer" 
      ...
      <style jsx global>{`
        @media (min-width: 768px) and (max-width: 1023px) {
          .digital-marketing-page .dm-hero-heading {
            font-size: 2.8rem;
            line-height: 1.2;
          }
          .digital-marketing-page .dm-hero-copy {
            font-size: 1rem;
          }
          .digital-marketing-page .dm-section-title {
            font-size: 1.75rem;
            line-height: 1.3;
          }
          .digital-marketing-page .dm-section-copy {
            font-size: 0.95rem;
          }
          .digital-marketing-page .dm-bullet-text {
            font-size: 0.75rem !important;
            line-height: 1.4;
          }
          .digital-marketing-page .dm-bullet-item {
            padding: 0.5rem 0.75rem !important;
          }
          .digital-marketing-page .dm-image-container {
          ...
          .digital-marketing-page .dm-image-container > div {
            height: 100%;
            display: flex;
            align-items: center;
          }
          .digital-marketing-page .dm-image-wrapper {
          ...
          .digital-marketing-page .dm-image-inner {
          ...
          .digital-marketing-page .dm-image {
            max-width: 100% !important;
          ...
          .digital-marketing-page .dm-image-container img[class*="object-cover"] {
